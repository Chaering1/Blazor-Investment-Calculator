using Competency6.Areas.Identity;
using Competency6.Data;
...
using MyInvestmentApp.Data.Repos;
...
{
    var dataContext = scope.ServiceProvider.GetRequiredService<MyInvestmentAppDBContext>();
